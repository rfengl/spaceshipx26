...
/**
 * The login cockpit window: a metal porthole looking out into space — drifting
 * stars, a nebula, a planet, a passing spaceship and the occasional shooting
 * star. Purely decorative (aria-hidden); all of its styling lives in the
 * co-located PortHole.css so the bespoke artwork stays out of the main code.
 */
